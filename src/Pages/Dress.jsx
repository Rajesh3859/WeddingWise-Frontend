...
<div className=" flex flex-col lg:flex-row w-full h-max max-w-full  bg-fuchsia-400 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div className="px-5 pb-5 ">
        ...
        <div className="flex items-center justify-between" >
            <span className="text-xl text-gray-900 font-light dark:text-white">From Rs.6000</span>
...
<div className=" flex flex-col lg:flex-row w-full h-max max-w-full   bg-fuchsia-400 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <Link to="#">
        <img className="p-8 rounded-t-lg h-96 max-w-96" src="https://cdn0.weddingwire.in/vendor/9421/3_2/1280/png/peter-england-15_15_199421-1563373528.webp" alt="Photography image" />
    </Link>
    <div className="px-5 pb-5 ">
        <Link to="#">
            <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white mt-7">Peter England </h5>
        </Link>
        <br />
        <p>Peter England is a retail store located in the city of Chennai. Originally the brand was founded to provide British soldiers with fine clothing during a war but soon found its way to Indian markets providing the exquisite of the menswear that you can choose to flaunt on your special occasions. It has been among the top menswear brands in the country holding its reputation by providing products and services that are not only best in quality but a className apart. With a staunch belief in authenticity, it has become one of the most trusted brands that offer and adds value and charm to groomswear. </p>
        <div className="flex items-center mt-24">
            <div className="flex items-center space-x-1 rtl:space-x-reverse">
                <svg className="w-4 h-4 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                    <path d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z"/>
        ...
        <br />
        <div className="flex items-center justify-between" >
            <span className="text-xl text-gray-900 font-light dark:text-white"> From Rs.7500</span>
...
<div className=" flex flex-col lg:flex-row w-full h-max max-w-full  bg-fuchsia-400 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <Link to="#">
        <img className="p-8 rounded-t-lg h-96 max-w-96" src="https://cdn0.weddingwire.in/vendor/7261/original/1280/jpg/the-arvind-store-2_15_197261-1560615083.webp" alt="Photography image" />
    </Link>
    <div className="px-5 pb-5 ">
        <Link to="#">
            <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white mt-7">The Arvind Store</h5>
        </Link>
        <br />
        ...
        <br />
        <div className="flex items-center justify-between" >
            <span className="text-xl text-gray-900 font-light dark:text-white">From Rs.4000</span>
