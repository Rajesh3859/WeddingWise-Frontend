      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 bg-black">
          ...
          <div className="max-w-sm mt-10 mb-5 ml-6 mr-3 p-6 hover:bg-violet-300 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-black">
            ...
            <br />
            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
              The bride is the heart of every wedding, bringing grace, beauty,
          ...
          <div className="max-w-sm mt-10 mb-5 ml-6 mr-3 p-6 hover:bg-violet-300 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-black">
            ...
            <br />
            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
              Make your first impression unforgettable with our elegant and
              unique wedding invitation cards!
            </p>
            <br />
            <Link
              to="/invitation"
