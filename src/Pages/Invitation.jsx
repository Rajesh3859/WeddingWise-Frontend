...
<div className="flex flex-col lg:flex-row w-full h-max max-w-full  bg-fuchsia-400 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <Link to="#">
        <img className="p-8 rounded-t-lg h-96 max-w-96" src="https://cdn0.weddingwire.in/vendor/1053/original/1280/jpg/evening-events.webp" alt="Photography image" />
    </Link>
    <div className="px-5 pb-5 ">
        <Link to="#">
            <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white mt-7">Miracle Wedding Cards</h5>
        </Link>
        <br />
        ...
        <div className="flex items-center justify-between" >
            <span className="text-xl text-gray-900 font-light dark:text-white">From Rs.10</span>
...
<div className=" flex flex-col lg:flex-row w-full h-max max-w-full   bg-fuchsia-400 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <Link to="#">
        <img className="p-8 rounded-t-lg h-96 max-w-96" src="https://cdn0.weddingwire.in/vendor/6579/original/1280/jpg/22550038-1509731929116881-5261351940483134530-n_15_186579.webp" alt="Photography image" />
    </Link>
    <div className="px-5 pb-5 ">
        <Link to="#">
            <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white mt-7">Wedding Invitation Cards </h5>
        </Link>
        <br />
        ...
        <br />
        <div className="flex items-center justify-between" >
            <span className="text-xl text-gray-900 font-light dark:text-white">From Rs.8</span>
...
<div className=" flex flex-col lg:flex-row w-full h-max max-w-full  bg-fuchsia-400 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <Link to="#">
        <img className="p-8 rounded-t-lg h-96 max-w-96" src="https://cdn0.weddingwire.in/vendor/6579/3_2/960/jpg/22492004-1509727852450622-8400186164059087962-n_15_186579.webp" alt="Photography image" />
    </Link>
    <div className="px-5 pb-5 ">
        <Link to="#">
            <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white mt-7">Shankesvar Cards</h5>
        </Link>
        <br />
        ...
        <br />
        <div className="flex items-center justify-between" >
            <span className="text-xl text-gray-900 font-light dark:text-white">From Rs15</span>
