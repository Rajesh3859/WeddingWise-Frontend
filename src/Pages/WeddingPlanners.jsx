...
<div className=" flex flex-col lg:flex-row w-full h-max max-w-full  bg-fuchsia-400 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <Link to="#">
        <img className="p-8 rounded-t-lg h-96 max-w-96" src="https://cdn0.weddingwire.in/vendor/0771/original/1280/jpeg/0j1a0351_15_70771-168882306236739.webp" alt="Photography image" />
    </Link>
    <div className="px-5 pb-5 ">
        <Link to="#">
            <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white mt-7">Bonvera</h5>
        </Link>
        <br />
        ...
        <div className="flex items-center justify-between" >
            <span className="text-xl text-gray-900 font-light dark:text-white">Rs.3,50,000</span>
...
<div className=" flex flex-col lg:flex-row w-full h-max max-w-full   bg-fuchsia-400 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <Link to="#">
        <img className="p-8 rounded-t-lg h-96 max-w-96" src="https://cdn0.weddingwire.in/vendor/7413/3_2/1280/jpg/copy-of-img-4232_15_197413-171171308384317.webp" alt="Photography image" />
    </Link>
    <div className="px-5 pb-5 ">
        <Link to="#">
            <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white mt-7">Watermark Event </h5>
        </Link>
        <br />
        ...
        <br />
        <div className="flex items-center justify-between" >
            <span className="text-xl text-gray-900 font-light dark:text-white">Rs.2,70,000</span>
...
<div className=" flex flex-col lg:flex-row w-full h-max max-w-full  bg-fuchsia-400 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <Link to="#">
        <img className="p-8 rounded-t-lg h-96 max-w-96" src="https://cdn0.weddingwire.in/vendor/7676/original/1280/jpg/weddingplanner-modern-events-weddingdecor-3_15_457676-169873394855555.webp" alt="Photography image" />
    </Link>
    <div className="px-5 pb-5 ">
        <Link to="#">
            <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white mt-7">Modern Events</h5>
        </Link>
        <br />
        <p>Modern Events is a wedding planning company based in the city of Goa. They can offer you the best in className assistance and plan each of your wedding functions most delightfully. Weddings in India are a lavish celebration with many different functions spread over weeks. If you are looking for a professional team of wedding planners who can be assured of giving you the perfect wedding assistance, then you should opt for Modern Events. They have been in the business for years and are a self-motivated team of individuals who can offer you the best wedding packages. </p>
        <div className="flex items-center mt-24">
            <div className="flex items-center space-x-1 rtl:space-x-reverse">
                <svg className="w-4 h-4 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                    <path d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z"/>
        ...
        <br />
        <div className="flex items-center justify-between" >
            <span className="text-xl text-gray-900 font-light dark:text-white">Rs.3,35,000</span>
