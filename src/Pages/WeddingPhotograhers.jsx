...
<div className=" flex flex-col lg:flex-row w-full h-max max-w-full  bg-fuchsia-400 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <Link to="#">
        <img className="p-8 rounded-t-lg h-96 max-w-96" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSXUt_Y5GqmtE_AsHieyqNyFFEHfVZ6duskWw&s" alt="Photography image" />
    </Link>
    <div className="px-5 pb-5 ">
        <Link to="#">
